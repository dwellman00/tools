SELECT 
  ...
  Attr_IDS.uint_value AS IDS,
  Attr_Toner.string_value AS Toner,
  TagTree.tag AS TAG, 
...
FROM RackObject
  ...
  LEFT JOIN AttributeValue AS Attr_IDS ON (Attr_IDS.object_id = RackObject.id AND Attr_IDS.attr_id = 10009)
  LEFT JOIN AttributeValue AS Attr_Toner ON (Attr_Toner.object_id = RackObject.id AND Attr_Toner.attr_id = 10010)
